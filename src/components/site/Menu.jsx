      ...
      <div className="w-full max-w-7xl mx-auto px-6 lg:px-12">
        <Reveal className="max-w-3xl mb-16">
          ...
          <h2 className="font-heading font-light text-4xl lg:text-6xl text-dark leading-tight mb-6">
            I sapori del villaggio
          </h2>
          <p className="text-text-secondary text-base lg:text-lg leading-relaxed">
            Cucina molisana di casa, tra grigliate alla brace, pasta fatta a mano e ricette di famiglia, da gustare
            con vista sul parco.
          </p>
        </Reveal>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          <Reveal delay={0.2} className="lg:col-span-5 lg:sticky lg:top-28 space-y-5">
            <img src={IMAGES.primi} alt="Tagliatelle ai funghi porcini e tartufo nero" className="w-full h-72 object-cover" />
            <div className="grid grid-cols-2 gap-5">
              <img src={IMAGES.grigliata} alt="Grigliata mista di carne alla brace" className="w-full h-44 object-cover" />
              <img src={IMAGES.pizza} alt="Pizza leggera e gustosa" className="w-full h-44 object-cover" />
            </div>
            <div className="border-l-2 border-gold pl-5 py-2">
              <p className="font-heading text-2xl text-dark italic">Vino alla spina, sempre.</p>
              <p className="text-sm text-text-secondary mt-2 leading-relaxed">
                Ogni piatto si accompagna bene con il nostro vino alla spina e un buon caffè, prima di tornare a
